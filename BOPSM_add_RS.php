...
<body style="background-color: rgb(226, 240, 243);">
    ...
    <section class="login ps-3 pe-3" style="width: 100%;">
        <div>
          <h1 class="fw-bold">Enter Shop Details</h1>
          <div class="form-floating mb-3">
            <input type="text" class="form-control" id="floatingInput" placeholder="Enter Name">
            <label for="floatingInput"><i class="fa-solid fa-shop"></i> Shop Name</label>
          </div>
          <div class="form-floating mb-3">
          ...
          <div class="form-floating mb-3">
            ...
            <label for="floatingInput"><i class="fa-solid fa-shop"></i> Shop Address</label>
          </div>
          <div class="form-floating mb-3">
          ...
          <div class="bttn text-center mb-3" style="width: 100%;">
            <a href="./BOPSM_home.php" class="btn btn-primary" style="width: 100%; background: rgba(27, 154, 179, 1); padding: 12px 0px; border: 0; font-size: 20px;">Add Shop</a>
          </div>
          <div class="text-center">
            <h6>Share the Password with your Shop Retailer for Login Purpose</h6>
          </div>
        </div>
    </section>
