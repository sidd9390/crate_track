...
<body style="background-color: rgb(226, 240, 243);">
    <section class="ms-2 me-2 text-center" style="margin-top: 100px;">
        <div class="container">
            <div class="row">
                <div class="col-6 p-2" onclick="f3()" id="sales_cat" style="border-bottom-left-radius: 8px; border-top-left-radius: 8px;">
                    <a href="#" style="width: 100%; height: 100%; color: white; text-decoration: none;">Sales Pilots</a>
                </div>
                <div class="col-6 p-2" onclick="f4()" id="retailer_cat" style="border-bottom-right-radius: 8px; border-top-right-radius: 8px;">
